...
UE.I18N['zh-cn'] = {
    'labelMap':{
        ...
        'mergecells':'合并多个单元格', 'deletetable':'删除表格', 'cleardoc':'清空文档','insertparagraphbeforetable':"表格前插入行",'insertcode':'代码语言','fontfamily':'字体', 'fontsize':'字号', 'paragraph':'段落格式',
        'edittable':'表格属性','edittd':'单元格属性', 'searchreplace':'查询替换', 'map':'Baidu地图',
        'insertvideo':'★ 视频分享', 'help':'帮助', 'justifyleft':'居左对齐', 'justifyright':'居右对齐', 'justifycenter':'居中对齐',
    ...
    'insertvideo':{
        'static':{
            lang_tab_insertV:"视频分享",
            lang_video_url:"视频flash地址",
