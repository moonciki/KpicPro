...
public class GeetestLib {
	...
	private static GeetestLib geetestLib = new GeetestLib();

	//公钥
	private String captchaId = "e384a0f7d293258a97419719139ae578";
	//私钥
	private String privateKey = "7612b1411220b9efb546cf245fdd7c59";
	...
	public static GeetestLib getGeetestLib(){
		return geetestLib;
	}
	...
	private String readContentFromGet(String getURL) throws IOException {
		...
		connection.setConnectTimeout(200);// 设置连接主机超时（单位：毫秒）
		connection.setReadTimeout(200);// 设置从主机读取数据超时（单位：毫秒）
