...
(function ($) {
    ...
    var DanmuPlayer = function (element, options) {
        ...
        this.$element.append('<div class="danmu-cover"></div>');
        ...
        this.$ctrlMain.append('<div class="opt-btn ctrl-btn " style="padding-top: 10px"><span class="glyphicon glyphicon-text-color" aria-hidden="true"></div>');
        this.$ctrlMain.append('<input class="danmu-input ctrl-btn"  type="textarea" placeholder="一触即发" id="danmu_text" max=100 />');
        this.$ctrlMain.append('<div class=" send-btn  ctrl-btn">发射-></div>');
        this.$ctrlMain.append('<div class="full-screen   ctrl-btn-right" style="padding-top: 10px;"><span class=" glyphicon glyphicon-resize-full" aria-hidden="true"></span></div>');
        this.$ctrlMain.append('<div class="loop-btn   ctrl-btn-right" style="padding-top: 10px;"><span class="glyphicon glyphicon-retweet" aria-hidden="true"></span></div>');
        this.$ctrlMain.append('<div class="show-danmu  ctrl-btn-right ctrl-btn-right-active" style="padding-top: 10px;"><span class="glyphicon glyphicon-comment" aria-hidden="true"></span></div>');
        ...
        $("body").append('<div id="' + this.id.slice(1, this.id.length) + 'fontTip"  hidden="true">' +
            ...
            '<input type="radio" checked="checked"  name="danmu_position" value=0 />滚动弹幕&nbsp;&nbsp;<input type="radio" name="danmu_position" value=1 />顶端弹幕&nbsp;&nbsp;<input type="radio" name="danmu_position" value=2 />底端弹幕' +
            '<form  id="danmu-size" ><br/>弹幕大小：<input   type="radio" checked="checked"  name="danmu_size" value="1" />大号文字&nbsp;&nbsp;' +
            '<input   type="radio" name="danmu_size" value="0" />小号文字&nbsp;&nbsp;</form>' +
