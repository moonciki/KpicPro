        ...
        if(data == "" || data == null){
            ...
            for(key in data){
                addhtml+="<div class=\"pbar_con\"><div class=\"pbar_con_1\"><div class=\"pbar_con_1_1\">"+
                    "<img src=\""+data[key].logo+"?imageView2/1/w/100/h/100/interlace/0/q/95\" style=\"border-radius: 6px;border: solid 2px "+data[key].color+";box-shadow:0px 0px 26px "+data[key].color+";\"/>"+
