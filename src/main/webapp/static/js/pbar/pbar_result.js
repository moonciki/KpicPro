        ...
        if(data == "" || data == null){
            ...
            for(key in data){
                addhtml+="<div class=\"pbar_con\"><div class=\"pbar_con_1\"><div class=\"pbar_con_1_1\">"+
                    ...
                    "</div><div class=\"pbar_con_1_2\"><span style=\"font-size: 21px; font-weight: bold\">"+data[key].name+"</span>&nbsp;&nbsp;<a href=\"/post/subjects/sub4615"+data[key].id+"\" target=\"_blank\"><span class='glyphicon glyphicon-arrow-right'></span>&nbsp;进入话题</a><br/>"+
