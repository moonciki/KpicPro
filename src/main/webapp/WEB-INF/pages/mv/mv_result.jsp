...
<div class="s_main">
  <center>
    <span style="font-size: 30px; color:#ff3e68;font-weight: bold">音频搜索</span>
    <input type="text" class="form-control" id="ym_kw"
           placeholder="闲暇时光，你想听点什么？" value="${kw}" style="margin-left:20px;border:2px #ADADAD solid;width:460px;height:35px;display:inline;">
    <button type="button" id="ym_s" class="btn btn-info" style="margin-top:-3px;background-color:#ff3e68;border:1px solid #ff3e68;display: inline"><span class="glyphicon glyphicon-search"></span>&nbsp;搜索</button>
    <button type="button" id="cjht" class="btn btn-info" style="margin-top:-3px;background-color:#ff3e68;border:1px solid #ff3e68;display: inline"><span class="glyphicon glyphicon-plus-sign"></span>&nbsp;创建放送单</button>
  </center>
</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/mv/mv_result.js"></script>
