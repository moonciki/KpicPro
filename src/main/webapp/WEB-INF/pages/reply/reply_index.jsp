    ...
    <div class="reply_body_main">
      <div class="reply_body_main_01" style="padding-left: 0px">
        ...
        <c:if test="${postMSg.isjm == 1}">
          <div class="manager_avater2"><img src="http://7xwibn.com1.z0.glb.clouddn.com/static/wangguan.png?imageView2/1/w/37/h/27/q/95/"/></div>
        </c:if>
        </div>
      <c:choose>
      ...
      <c:if test="${reply != null}">
        <div class="reply_body_main"><div class = "reply_body_main_01">
          <c:choose>
            ...
            <c:otherwise>
              <img src="${reply.avater}?imageView2/1/w/70/h/70/interlace/0/q/95" class="userpic_hpost"/>
            </c:otherwise>
          </c:choose>
